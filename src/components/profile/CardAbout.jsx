...
const CardAbout = ({ setSelectedId, about, setUserProfile, userProfile }) => {
  ...
  return (
    <div className="lg:w-1/2 lg:h-1/2 dark:bg-dark-third bg-light-primary mx-auto mt-4 lg:my-auto h-64 flex flex-col justify-between rounded-lg p-4">
      ...
      <textarea
        ...
        value={text}
        className="dark:bg-dark-secondary resize-none p-4 focus:outline-none rounded h-1/2"
        maxLength="190"
      />
      <div className="dark:bg-dark-secondary rounded-b text-end p-1 text-xs text-gray-400">
        {190 - text.length}
      </div>
      <AnimatePresence>
        {change && (
          ...
          >
            ...
            <div className="flex">
              <button
                ...
                className="mr-2 hover:underline dark:text-gray-300 text-gray-500"
              >
                reset
              </button>
              <button
