...
import CardContact from "./profile/CardContact";
...
const Profile = ({ user }) => {
  ...
  return (
    <MainPageContainer>
      <div className="grid grid-cols-4 gap-6 p-6 h-full relative auto-rows-max">
        ...
        <div className="col-span-3 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-150 rounded">
          <motion.div
            layoutId="preview"
        ...
        <div className="col-span-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-150 rounded h-[294px]">
          <motion.div
            layoutId="intro"
        ...
        <div className="col-span-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-150 rounded">
          <motion.div
            layoutId="contact"
