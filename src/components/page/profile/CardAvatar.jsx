...
const CardAvatar = ({
  ...
  return (
    <div className="w-1/2 h-1/2 bg-dark-third m-auto flex flex-col justify-between rounded-lg p-4">
      ...
      <div className="flex justify-between mb-2">
        <div className="w-1/2 text-center">Preview</div>
        <div className="w-1/2 text-center">Background</div>
      </div>
      <div className="flex justify-between mb-auto text-center">
        ...
        <div>
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="w-24 h-24 bg-slate-500 rounded-lg"
            >
              Default
            </button>

            <button className="w-24 h-24 bg-slate-500 rounded-lg">
              Custom
            </button>
            <button
              onClick={() => setCustomColor(!customColor)}
              className="w-24 h-24 rounded-lg bg-slate-500 col-start-2 col-span-1"
            >
              Custom Color
            </button>
          </div>
